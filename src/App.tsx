...
import { CULTURE_ITEMS, PILLARS, getItemId } from "./data/culture";
  ...
  return (
    <div className="ukraine-root">
      ...
      <div className="footer-bar">
        <div className="footer-motto">Slava Ukraini — Glory to Ukraine</div>
        <a 
          href="https://github.com/rgalvao/ukraine-timeline" 
          target="_blank" 
